...
bool sorting(FootballTeam a, FootballTeam b){
...
int main()
{
    const std::string FILENAME = "/Users/crazyrinchik/Desktop/Workspace/football.csv";
    ...
    std::sort(teams.begin(), teams.end(), sorting);
    std::cout << "Teams info: \n";
    for (auto team: teams){
